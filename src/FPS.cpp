/**
 * \file FPS.cpp
 * \brief fps.json: the schema and the doors.
 *
 * Sections in the order of IMP/bff/FPS.h; each is marked with the file it
 * came from.
 *
...
// -------- from FPSSchema.cpp --------
/**
 * (formerly FPSSchema.cpp, now a section of this file)
...
// -------- from FPSIO.cpp --------
/**
 * (formerly FPSIO.cpp, now a section of this file)
