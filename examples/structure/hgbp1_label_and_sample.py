...
# dye's internal degrees of freedom and write a trajectory, driven by the
# linker samplers the module publishes flat: IMP.bff.RRTTree, resample_av and
# the FFSampling family.
