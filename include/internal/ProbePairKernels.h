/**
 *  \file IMP/bff/internal/ProbePairKernels.h
 *  \brief The chi-squared kernels behind greedy probe selection (Olga).
 *
 * Shared by the free selectors (ProbePairSelection.cpp) and the resolution
 * term of #IMP::bff::ProbeNetworkSelection (ProbeNetworkSelection.cpp), so
 * both score with one copy of the arithmetic. Moved out of
 * ProbePairSelection.cpp unchanged.
 *
 *  Copyright 2007-2026 IMP Inventors. All rights reserved.
 */
#ifndef IMPBFF_INTERNAL_PROBE_PAIR_KERNELS_H
#define IMPBFF_INTERNAL_PROBE_PAIR_KERNELS_H
...
inline double chi2_tail_one(double x, int ndof) {
...
inline void score_candidates(const double* rmsds, const double* chi2,
...
inline double weighted_column_mean(const double* rmsds, const double* chi2, int ndof,
...
inline void add_pair_to_chi2(std::vector<double>& chi2, const double* e,
...
#endif  // IMPBFF_INTERNAL_PROBE_PAIR_KERNELS_H
