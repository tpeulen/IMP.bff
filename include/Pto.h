 ...
 *         and the MFDB profile that says what they mean.
 *
 *  Two sections: the **container** (the former body of this file) and the
 *  **profile** (formerly `PtoProfile.h`) -- PTO.MFDB, the vocabulary layer
 *  over the container: which terms, which versions, which tags a payload
 *  may carry.
 *
...
// -------- from PtoProfile.h --------
/**
 *  (formerly IMP/bff/PtoProfile.h, now a section of this file)
